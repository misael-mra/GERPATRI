...
if(isset($_POST['a_tombo']) && strlen($_POST['a_tombo']))
{
  ...
  if($results = find_all_asset_info_by_tombo($asset_tombo)){
    ...
    foreach ($results as $result) {
      ...
      $html .= "<td>";
      $html .= "<select class=\"form-control\" name=\"domain\" required>";
      $html .=    "<option selected value=\"\">Selecione</option>";
      foreach ($all_domain as $dom):          
      ...
      $html  .= "<button type=\"submit\" name=\"add_transfer\" class=\"btn btn-warning\">Registrar Baixa</button>";
      $html  .= "</td>";
